...
(let* (
  ...
  (let ((bfTEST2 bfTEST))
    ...
    (if (premisseAppartientBf premisseVrai2 bfTEST2)
      (print "Test 6 reussi")
      (print "Test 6 échoué : premisseVrai2 non validée")
    )
    (mettreAJourPremisseBf premisseVrai2 bfTEST2)
    (if (not (premisseAppartientBf premisseVrai2 bfTEST2))
      (print "Test 7 reussi")
      (print "Test 7 échoué : premisseVrai2 validée après modification")
    )
  )
)
